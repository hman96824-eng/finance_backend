...
router
  ...
  .get("/inactive", middleware.authenticate, checkPermission(["manage_users"]), userController.InactiveUserStatus) // all InActive user's
  ...
  // User's Status
  .delete("/remove/:id", middleware.authenticate, checkPermission(["view_users"]), userController.RemoveUnacceptedUser) // unaccepted user
  // Send Invitation
